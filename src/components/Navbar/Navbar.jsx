    ...
    return (
        <header className="p-4 bg-gray-500">
            <div className="container flex justify-between items-center h-6 mx-auto">
                <a rel="noopener noreferrer" href="#" aria-label="Back to homepage" className="flex items-center p-2 text-white">
                ...
                <ul className="items-stretch hidden space-x-3 lg:flex">
                    <li className="flex">
                        <NavLink to={'/'} rel="noopener noreferrer"
                            ...
                            className={({ isActive }) => `text-white ${isActive ? "active font-bold" : ""}`}
                        >Home</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to={'/about'} rel="noopener noreferrer"
                            className={({ isActive }) =>
                                `text-white ${isActive ? "active font-bold" : ""}`
                            }
                        >About</NavLink>
                    </li>
                    <li className="flex">
                        <NavLink to={'/blog'} rel="noopener noreferrer"
