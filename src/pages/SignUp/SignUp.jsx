        ...
        <form onSubmit={handleSignUp} className="space-y-3">
            <div className="space-y-2">
                ...
                <div className="space-y-1">
                    ...
                    <input type="text" name="name" id="name" placeholder="Leroy" className="w-full px-3 py-2 border rounded-md dark:border-gray-300 dark:bg-gray-50 dark:text-gray-800 focus:dark:border-violet-600" />
                </div>
            ...
            <button type="submit" className="w-full px-8 py-2 font-semibold rounded-md cursor-pointer bg-gray-500">Sign Up</button>
            <div className='text-start'>
                Already have a account? <span className='font-bold hover:underline cursor-pointer'>Sign in</span>
            </div>
        </form>
    </div>
    );
