...
const SignIn = () => {
    ...
    return (
        <>
            <div className="w-full max-w-md mx-auto rounded-md shadow sm:p-8 bg-gray-400  mt-4">
                <h2 className="mb-2 text-3xl font-semibold text-center">Login to your account</h2>
                <p className="mb-4 text-sm text-center dark:text-gray-600">Dont have account?
                ...
                <div className="my-1 space-y-2">
                    ...
                    <button aria-label="Login with Twitter" role="button" className="flex items-center justify-center w-full p-2 space-x-4 border rounded-md focus:ring-2 focus:ring-offset-1 dark:border-gray-600 focus:dark:ring-violet-600">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
                ...
                <form  onSubmit={handleSignIn} className="space-y-3">
                    ...
                    <button type="submit" className="w-full px-8 py-2 font-semibold rounded-md bg-gray-600 text-white cursor-pointer">Sign in</button>
                </form>
            </div>
        </>
    );
